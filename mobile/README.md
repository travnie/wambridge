...
- an in-app speaker remote plus a compact toggle widget and expanded widget; both share the
  same play/pause, mute and raw-volume routing for radio and native speaker playback;
