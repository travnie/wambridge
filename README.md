...
[![Release](https://github.com/travnie/wambridge/actions/workflows/release.yml/badge.svg)](https://github.com/travnie/wambridge/actions/workflows/release.yml) [![code license](https://img.shields.io/github/license/travnie/wambridge?label=code&logo=opensourceinitiative&logoColor=white&color=6f42c1&style=flat-square)](https://spdx.org/licenses/ISC) <a href="https://deepwiki.com/travnie/wambridge"><img src="https://deepwiki.com/badge.svg" alt="DeepWiki"></a>
...
```powershell
git clone https://github.com/travnie/wambridge.git
cd wambridge
py -m venv .venv
